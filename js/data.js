...
const CALC_DATA = {
  ...
  defaultRates: {
    ...
    market: {
      ...
      JPY100_ATB: 49.70,      // курс 100 JPY (АТБ банк / SWIFT) — обычные авто
      JPY100_sanctioned: 69.00,// курс 100 JPY для САНКЦИОННЫХ авто (платёж дороже)
  ...
  expensePresets: {
    ...
    // Япония — САНКЦИОННОЕ авто: дороже расходы по РФ (брокер) и платёж за авто (курс 69)
    jp_sanctioned: {
      label: 'Япония 🇯🇵 (санкции)',
      currency: 'JPY',
      commission: 50000,
      bankFeePercent: 0,   // курс 69 для санкционных уже «всё включено»
      items: [
        { key:'broker',   label:'Услуги брокера / СБКТС / ЭПТС / Лаборатория (санкции)', value:65000 },
        { key:'tech',     label:'Справка на техническое средство', value:550 },
        { key:'svh',      label:'СВХ (хранение и ПРР)', value:3000 },
        { key:'export',   label:'Вывоз в ТК', value:5000 },
      ],
